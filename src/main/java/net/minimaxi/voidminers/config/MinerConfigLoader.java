...
public class MinerConfigLoader {
    ...
    public Map<String, ControllerConfig> MINER_CONFIGS = MapUtil.of(
            MapUtil.createEntry("rubetine", new ControllerConfig(10000, 1000, 300,
                    MapUtil.of(
            ...
            MapUtil.createEntry("aurantium", new ControllerConfig(25000, 900, 350,
                    MapUtil.of(
            ...
            MapUtil.createEntry("citrinetine", new ControllerConfig(50000,800, 400,
                    MapUtil.of(
            ...
            MapUtil.createEntry("verdium", new ControllerConfig(100000,700, 450,
                    MapUtil.of(
            ...
            MapUtil.createEntry("azurine", new ControllerConfig(350000,600, 500,
                    MapUtil.of(
            ...
            MapUtil.createEntry("caerium", new ControllerConfig(3000000,500, 550,
                    MapUtil.of(
            ...
            MapUtil.createEntry("amethystine", new ControllerConfig(20000000,400, 600,
                    MapUtil.of(
